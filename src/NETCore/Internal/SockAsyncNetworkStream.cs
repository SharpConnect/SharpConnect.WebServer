...
namespace SharpConnect.Internal
{
    ...
    /// </summary>
    public abstract class AbstractAsyncNetworkStream : Stream
    {
#if DEBUG
        ...
        internal abstract void ShutdownClientSocket();
        internal abstract Socket ClientSocket { get; }
        internal abstract int QueueCount { get; }
        internal abstract byte[] UnsafeGetInternalRecvBuffer();

        internal abstract void Reset2();

        internal bool UsedByWebsocket { get; set; }
    }
    ...
    class SockNetworkStream : AbstractAsyncNetworkStream
    {
        ...
        internal override int QueueCount => sendIO.QueueCount;
        internal override void Reset2()
        {
            if (UsedByWebsocket)
            {
                sendIO.Reset();
        ...
        internal override byte[] UnsafeGetInternalRecvBuffer()
        {
        ...
        internal override void ShutdownClientSocket()
        {
            try
            {
        ...
        internal override Socket ClientSocket => _socket;
    ...
    class SecureSockNetworkStream : AbstractAsyncNetworkStream
    {
        ...
        internal override int QueueCount => _socketNetworkStream.QueueCount;
        internal override byte[] UnsafeGetInternalRecvBuffer()
        {
            return _recvBuffer._largeBuffer;
        }
        ...
        internal override Socket ClientSocket => _socketNetworkStream.ClientSocket;
        internal override void ShutdownClientSocket()
        {
            _socketNetworkStream.ShutdownClientSocket();
        }
        internal override byte RecvReadByte(int pos)
        {
