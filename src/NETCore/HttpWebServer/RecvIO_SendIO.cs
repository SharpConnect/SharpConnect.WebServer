...
namespace SharpConnect.Internal
{
    ...
    class RecvIO : INewRecvIO
    {
        ...
        public int BytesTransferred
        {
            get
            {
                if (_networkStream != null)
                {
                    return _networkStream.ByteReadTransfered;
                }
                return recvArgs.BytesTransferred;
            }
        }
    ...
    class RecvIOBuffer : IDisposable
    {
        ...
        int totalLen = 0;
        int bufferCount = 0;
        //INewRecvIO _latestRecvIO;
        INewRecvIO _latestRecvIO;
        public RecvIOBuffer(INewRecvIO recvIO)
        {
